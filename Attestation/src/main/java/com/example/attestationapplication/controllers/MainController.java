package com.example.attestationapplication.controllers;

import com.example.attestationapplication.enumm.Status;
import com.example.attestationapplication.models.Cart;
import com.example.attestationapplication.models.Order;
import com.example.attestationapplication.models.Person;
import com.example.attestationapplication.models.Product;
import com.example.attestationapplication.repositories.CartRepository;
import com.example.attestationapplication.repositories.OrderRepository;
import com.example.attestationapplication.repositories.ProductRepository;
import com.example.attestationapplication.security.PersonDetails;
import com.example.attestationapplication.services.PersonService;
import com.example.attestationapplication.services.ProductService;
import com.example.attestationapplication.util.PersonValidator;
                ...
                if(price.equals("sorted_by_ascending_price")) {
                    if (!contract.isEmpty()) {
                        if (contract.equals("footwear")) {
                            ...
                            model.addAttribute("search_product", productRepository.findByTitleAndCategoryOrderByPriceAsc(search.toLowerCase(), Float.parseFloat(ot), Float.parseFloat(Do), 10));
                        } else if (contract.equals("clothes")) {
                            model.addAttribute("search_product", productRepository.findByTitleAndCategoryOrderByPriceAsc(search.toLowerCase(), Float.parseFloat(ot), Float.parseFloat(Do), 9));
                        }
                    } else {
